...
if __name__=='__main__':
    ...
    print(f"Working with INTERVENTION embeddings ({len(gensim_config['intervention_configs'])})")
    ...
    print()
    print(f"Working with DIAGNOSIS embeddings ({len(gensim_config['diagnosis_configs'])})")
