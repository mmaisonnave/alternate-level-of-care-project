...
if __name__=='__main__':
    ...
    logging.debug('\n')
    logging.debug('Unifying two files (CZ and Non-CZ) into one. Script: creating_single_csv.py')
    ...
    logging.debug(f'CZ files read. Shape={cz_df.shape}')
    logging.debug('Adding additional columns (derived from others): is ALC, Total days in hospital, etc.')
    ...
    logging.debug(f'Final shape of CZ files dataframe = {cz_df.shape}')

    # ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
    # READING Non-CZ FILES
    # ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------   
    noncz_df = pd.read_csv(config['unified_merged_file_noncz'])
    logging.debug(f'Non-CZ files read. Shape={noncz_df.shape}')
    logging.debug('Adding additional columns (derived from others): is ALC, Total days in hospital, etc.')
    ...
    logging.debug(f'Final shape of Non-CZ files dataframe = {noncz_df.shape}')
